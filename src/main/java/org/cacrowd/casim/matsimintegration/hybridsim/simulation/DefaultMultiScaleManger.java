...
@Singleton
public class DefaultMultiScaleManger implements MultiScaleManger, AfterMobsimListener {

    private static final Logger log = Logger.getLogger(DefaultMultiScaleManger.class);
    ...
    @Inject
    public DefaultMultiScaleManger(QuantityAnalyzer qa, FlowAnalyzer fa) {
        this.qa = qa;
        this.fa = fa;
    }
