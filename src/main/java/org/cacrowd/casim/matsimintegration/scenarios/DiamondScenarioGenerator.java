...
public class DiamondScenarioGenerator {
    ...
    */
    ...
    private static double passagesWidthEntranceScale = 1.5;
    ...
    private static HybridSimProto.Scenario createScenario(double scenarioWidth, double scenarioHeight, double passagesWidth) {
        ...
        //BEGIN entrance
        cb.setX(0.5);
        cb.setY(scenarioHeight / 2 - passagesWidth * passagesWidthEntranceScale);
        eb.setC0(cb.build());
        cb.setY(scenarioHeight / 2 + passagesWidth * passagesWidthEntranceScale);
        eb.setC1(cb.build());
        ...
        cb.setX(0.5);
        cb.setY(scenarioHeight / 2 - (passagesWidth * passagesWidthEntranceScale + 0.4));
        eb.setC0(cb.build());
        cb.setX(4.5);
        eb.setC1(cb.build());
        eb.setType(HybridSimProto.Edge.Type.OBSTACLE);
    ...
    private static void createPopulation(Scenario sc) {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            if (i % 2 == 0) {
                ...
                pers = fac.createPerson(Id.createPersonId(i));
            } else {
